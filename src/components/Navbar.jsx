...
const Navbar = () => {
  ...
  return (
    <div className="fixed top-4 left-1/2 z-50 w-[95%] max-w-8xl -translate-x-1/2">
      <nav className="navbar bg-base-100/80 backdrop-blur-md rounded-xl border border-base-300 px-5 shadow-lg">
        {/* Logo */}
        ...
        <header className="mx-auto flex h-16 max-w-7xl items-center justify-between px-2 gap-8">
         ...
         {!user && (
            <div className="hidden items-center gap-4 md:flex">
              ...
              <Link href="/signup" className="btn glitch-btn">
                Sign Up
              </Link>
            </div>
          )}
